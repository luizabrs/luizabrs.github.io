...
The tool is made of different components and assist developers working on the Linux kernel. It helps and automates the working flow of developers working on the Linux Kernel.
...
## Finding and issue to contribute - a good first issue :smiley:

If you look up on the documentation mentioned above, you will find more than 150 [issues](https://github.com/kworkflow/kworkflow/issues) opened by contributors than can (or need) to be solved.

Scrolling around, you can find the ones labelled as `good first issue`, which helped us find `issue #69` to be the to contribute.
...
Or as the issue author mentioned: 
...
This part of the post was base of the TA's pad about `kw-contribution-guide`.
...
It was quite easy to fix since it was a `\newline` specification that made extra gaps on the typing.
